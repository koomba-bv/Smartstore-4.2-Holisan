...
namespace SmartStore.Core.Domain.Catalog
{
    ...
    public partial class Product : BaseEntity, IAuditable, ISoftDeletable, ILocalizedEntity, ISlugSupported, IAclSupported, IStoreMappingSupported, IMergedData
    {
        ...
        /// <summary>
        /// KOOMBA
		/// Gets or sets a value that indicates whether the product is eligible for free products
		/// </summary>
		[DataMember]
        ...
        /// <summary>
        /// KOOMBA
		/// Gets or sets a value that indicates at what amount the product is eligible for free products
		/// </summary>
		[DataMember]
