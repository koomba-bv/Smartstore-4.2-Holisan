...
namespace SmartStore.Admin.Controllers
{
    ...
    public partial class ProductController : AdminControllerBase
    {
        ...
        protected void UpdateProductPrice(Product product, ProductModel model)
        {
            ...
            p.HasFreeProducts = m.HasFreeProducts;      // KOOMBA
            p.MinProductAmount = m.MinProductAmount;  // KOOMBA
        ...
        protected void PrepareProductModel(ProductModel model, Product product, bool setPredefinedValues, bool excludeProperties)
        {
            ...
            if (product != null)
            {
                ...
                model.HasFreeProducts = product.HasFreeProducts;        // KOOMBA
                model.MinProductAmount = product.MinProductAmount;    // KOOMBA
            ...
            if (setPredefinedValues)
            {
                ...
                model.HasFreeProducts = false;
                model.MinProductAmount = 1;
            }
        }
