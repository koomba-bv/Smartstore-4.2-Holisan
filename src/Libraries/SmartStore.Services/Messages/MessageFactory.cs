...
namespace SmartStore.Services.Messages
{
    public partial class MessageFactory : IMessageFactory
    {
            ...
            if (!isTransientTemplate)
            {
                switch (templateName)
                {
                    case MessageTemplateNames.SystemContactUs:
                        ...
                        break;
                    case MessageTemplateNames.SystemChangeAddress:
                        result.Add(new NamedModelPart("Message")
                        {
                            ["Subject"] = "Test subject",
                            ["Message"] = LoremIpsum,
                            ["SenderEmail"] = "jane@doe.com",
                            ["SenderName"] = "Jane Doe",
                            ["AddressTypeBillingText"] = "AddressTypeBillingText",
                            ["AddressTypeShippingText"] = "AddressTypeShippingText"
                        });
                        break;
        ...
        public object SendChangeAddressMessage(Customer customer, string email, string firstname, string sender, string phonenumber, LocalizedString subject, string body)
        {
