...
namespace SmartStore.Web.Controllers
{
    ...
    public partial class CheckoutController : PublicControllerBase
    {
        ...
        public ActionResult SelectBillingAddress(int addressId, bool useBillingAsShipping)
        {
            ...
            if (!useBillingAsShipping)
            {
                ...
                _workContext.CurrentCustomer.ShippingAddress.AddressType = "B";
                _customerService.UpdateCustomer(_workContext.CurrentCustomer);
        ...
        public ActionResult NewBillingAddress(CheckoutBillingAddressModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    _workContext.CurrentCustomer.ShippingAddress = address;
                    _workContext.CurrentCustomer.ShippingAddress.AddressType = "S";
                    _customerService.UpdateCustomer(_workContext.CurrentCustomer);

                    return RedirectToAction("ShippingMethod"); // Skip ShippingAddress step
                }
                else
                {
                    return RedirectToAction("ShippingAddress");
