...
namespace SmartStore.Admin.Models.Catalog
{
    ...
    public class ProductModel : TabbableModel, ILocalizedModel<ProductLocalizedModel>
    {
        ...
        // KOOMBA
        // Sets if the product is eligible for free products
        [SmartResourceDisplayName("Admin.Catalog.Products.Fields.HasFreeProducts")]
        public bool HasFreeProducts { get; set; }

        // KOOMBA
        // Sets at what amount the product is eligible for free products
        [SmartResourceDisplayName("Admin.Catalog.Products.Fields.MinProductsAmount")]
